...
API_ID = int(environ.get('API_ID', '26744179'))
API_HASH = environ.get('API_HASH', '9396d91b85063139080a4ef46a3e02c8')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/1Bp.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5357048091').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002166446304'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002493071106 -1001607040287 -1001803532121 -1001750117150 -1001981131674').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001981131674') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Janubapu:fjZ5KU4gSVFNxRDa@cluster0.ld2ya.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'publicfile123') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+wSO0pLqS7FxkZGM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+wSO0pLqS7FxkZGM1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RaolSaheb')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'yourdestinationlink.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'b48875c38f18035bc7d08aeaa3b9c141dd73ed36')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/c/1981131674/110104')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://ideological-arlana-rajadhiraj-46066fc5.koyeb.app/")
